...
Most of these come down to network reality or how opendota serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

opendota rate-limits like any public site. opendota already paces
...
Where a surface is gated, opendota reads a cookie or token you supply
...
`opendota`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what opendota actually did
